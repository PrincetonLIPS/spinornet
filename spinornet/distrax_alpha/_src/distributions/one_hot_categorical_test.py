...
import chex
from spinornet.distrax_alpha._src.distributions import categorical
from spinornet.distrax_alpha._src.distributions import one_hot_categorical
from spinornet.distrax_alpha._src.utils import equivalence
from spinornet.distrax_alpha._src.utils import math
import jax
...
class OneHotCategoricalTest(
    ...
    def setUp(self):
        ...
        self.assertion_fn = lambda x, y: np.testing.assert_allclose(
            x, y, rtol=RTOL)
    ...
    def test_num_categories(self, from_logits):
        dist_params = {'logits': self.logits} if from_logits else {
            'probs': self.p}
    ...
    def test_with_two_distributions(self, function_string, mode_string):
        super()._test_with_two_distributions(
            ...
            dist1_kwargs={'probs': np.array(
                [[0.1, 0.5, 0.4], [0.2, 0.4, 0.4]])},
    ...
    def test_with_categorical_and_one_hot_categorical(
        ...
        tfp_comp_dist1_dist2 = getattr(
            tfp_dist1, function_string)(tfp_dist2_aux)
        tfp_comp_dist2_dist1 = getattr(
            tfp_dist2_aux, function_string)(tfp_dist1)
    ...
    def test_slice(self, slice_):
        ...
        self.assertIsInstance(
            dist1_sliced, one_hot_categorical.OneHotCategorical)
        self.assertIsInstance(
            dist2_sliced, one_hot_categorical.OneHotCategorical)
