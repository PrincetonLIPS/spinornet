...
from spinornet.distrax_alpha._src.distributions import straight_through
    ...
    def test_sample(self, dist_params, sample_shape):
        ...
        def loss(dist_params, dist_cls, sample_shape):
            ...
            if hasattr(self, 'variant'):
                sample_fn_wrapper = self.variant(
                    static_argnums=(1,))(sample_fn_wrapper)
        ...
        def straight_through_tfp_loss(dist_params, dist_cls, sample_shape):
            ...
            try:
                dist_params['logits'] = math.normalize(
                    logits=dist_params['logits'])
            except KeyError:
                dist_params['probs'] = math.normalize(
        ...
        tfp_st_sample_grad_v = jnp.stack(
            jnp.array(*tfp_st_sample_grad.values()))
