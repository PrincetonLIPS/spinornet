...
from spinornet.distrax_alpha._src.distributions import quantized
from spinornet.distrax_alpha._src.distributions import uniform
...
class QuantizedSlicingTest(parameterized.TestCase):
    ...
    def test_slice(self, slice_, expected_batch_shape):
        ...
        self.assertion_fn(sliced_dist.distribution.low,
                          self.uniform_low[slice_])
        self.assertion_fn(sliced_dist.distribution.high,
                          self.uniform_high[slice_])
