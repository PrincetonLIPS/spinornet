...
import chex
from spinornet.distrax_alpha._src.distributions import gamma
...
class GammaTest(equivalence.EquivalenceTest, parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        ('2d dist, 2d value', ([0.1, -0.5],
         0.9 * np.ones(2)), np.array([1, 2])),
    ...
    @parameterized.named_parameters(
        ...
        ('entropy broadcasted concentration',
         (0.5, [0.5, 1.3, 1.5]), 'entropy'),
        ...
        ('variance broadcasted concentration',
         (0.5, [0.5, 1., 1.]), 'variance'),
