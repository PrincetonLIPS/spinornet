...
from spinornet.distrax_alpha._src.bijectors import bijector as base_bijector
from spinornet.distrax_alpha._src.bijectors import block
from spinornet.distrax_alpha._src.bijectors import chain
from spinornet.distrax_alpha._src.bijectors import diag_linear
from spinornet.distrax_alpha._src.bijectors import shift
from spinornet.distrax_alpha._src.distributions import independent
    ...
    def covariance(self) -> Array:
        ...
        if isinstance(self.scale, diag_linear.DiagLinear):
            result = jnp.vectorize(
                jnp.diag, signature='(k)->(k,k)')(self.variance())
        else:
...
def _kl_divergence_mvn_mvn(
    ...
    *unused_args, **unused_kwargs,
    ...
    diff_lob_abs_det = _log_abs_determinant(
        dist2) - _log_abs_determinant(dist1)
