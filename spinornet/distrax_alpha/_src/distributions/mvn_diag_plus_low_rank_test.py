    ...
    def test_with_two_distributions(self, function_string, mode_string):
        ...
        if mode_string == 'distrax_to_distrax':
            ...
            result1 = self.variant(
                getattr(distrax_dist1, function_string))(tfp_dist2)
            result2 = self.variant(
                getattr(distrax_dist2, function_string))(tfp_dist1)
        elif mode_string == 'tfp_to_distrax':
            result1 = self.variant(
                getattr(tfp_dist1, function_string))(distrax_dist2)
            result2 = self.variant(
                getattr(tfp_dist2, function_string))(distrax_dist1)
