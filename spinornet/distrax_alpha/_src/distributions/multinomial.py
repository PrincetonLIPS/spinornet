...
class Multinomial(distribution.Distribution):
    ...
    def __init__(self,
        ...
        chex.if_args_not_none(
            chex.assert_axis_dimension_gt, probs, axis=-1, val=1)
        chex.if_args_not_none(
            chex.assert_axis_dimension_gt, logits, axis=-1, val=1)
    ...
    def _sample_n(self, key: PRNGKey, n: int) -> Array:
        ...
        samples = sample_fn(keys, total_count, n, logits,
                            self._dtype)  # [n, B, K]
    ...
    def _sample_n_scalar(
        ...
        def body_func(args):
            ...
            sample_i = jax.random.categorical(
                current_key, logits=logits, shape=(n,))
    ...
    def _entropy_scalar(
        ...
        likelihood2 = math.power_no_nan(
            1. - probs[..., None], total_count - xi)
    ...
    def _entropy_scalar_with_lax(
        ...
        comb_term = jnp.sum(
            lax.while_loop(cond_func, body_func,
