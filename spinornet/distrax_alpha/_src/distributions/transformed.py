...
from spinornet.distrax_alpha._src.bijectors import bijector as bjct_base
from spinornet.distrax_alpha._src.distributions import distribution as dist_base
...
tfd.RegisterKL(Transformed, Transformed)(
