...
import chex
from spinornet.distrax_alpha._src.distributions import distribution as distrax_distribution
...
class Independent(distrax_distribution.Distribution):
    ...
    def __getitem__(self, index) -> 'Independent':
        ...
        index = distrax_distribution.to_batch_shape_index(
            self.batch_shape, index)
        return Independent(
...
tfd.RegisterKL(Independent, Independent)(
